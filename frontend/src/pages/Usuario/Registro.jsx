...
const Registro = () => { 
    ...
    const handleSudmit = async (e) =>{
        ...
        if(password !== repetirPassword){ setAlerta({msg: "Los password no son iguales", error: true});
        return;
    }
    ...
    try {
        ...
        setNombre(""); setEmail(""); setPassword(""); setRepetirPassword(""); setTelefono(""); setDireccion(""); setWeb("");
    } catch (error) {
        ...
        <div className='flex w-full'>
            ...
            <div className='flex flex-col justify-center items-center lg:w-2/4 mr-10 md:flex-row '>
                ...
                <div>
                    ...
                    <form onSubmit={handleSudmit} className='p-4 mx-auto w-96 sm:px-9 mt-8 shadow-md'>
                        ...
                        <div className='mb-5'>
                            ...
                            <input type="text" id="web" className='block placeholder-slate-400 p-2 w-full bg-slate-100' placeholder='https://github.com/IvanCastroRuiz' value={web} onChange={ e => setWeb(e.target.value) } />
                            </div> 
